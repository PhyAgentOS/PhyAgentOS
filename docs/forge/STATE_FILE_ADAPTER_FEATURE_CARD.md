...
- Verification Service HTTP conformance: `tests/test_verification_service_replay.py` covers authorization, request envelope validation, deterministic provider-backed replay, invalid-response normalization, and provider failure without external calls
